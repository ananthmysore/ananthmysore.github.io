...
function submitForm(){var a=$("#name").val(),b=$("#email").val(),c=$("#subject").val(),d=$("#message").val();$.ajax({type:"POST",url:"contact_me.php",data:"name="+a+"&email="+b+"&subject="+c+"&message="+d,success:function(a){"success"==a?formSuccess():(formError(),submitMSG(!1,a))}})}function formSuccess(){$("#contactForm")[0].reset(),submitMSG(!0,"Message Submitted!")}function formError(){$("#contactForm").removeClass().addClass("").one("",function(){$(this).removeClass()})}function submitMSG(a,b){if(a)var c="align-center alert alert-success";else var c="align-center alert alert-danger";$("#msgresult").removeClass().addClass(c).slideDown().text(b)}$("#contactForm").validator().on("submit",function(a){a.isDefaultPrevented()?(formError(),submitMSG(!1,"Did you fill in the form properly?")):(a.preventDefault(),submitForm())}),$("#contact-form input, #contact-form textarea").keyup(function(){$("#contact-form input, #contact-form textarea").css("border-color",""),$("#msgresult").slideUp()});
